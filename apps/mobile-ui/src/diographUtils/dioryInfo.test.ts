    ...
    describe("Photo with Mary & Jane", () => {
      ...
      it("Without explicitly selected story", () => {
        ...
        expect(dioryInfo).toMatchObject({
          ...
          stories: [
            expect.any(Object), // "3e2ddc49-b3b6-4212-8a0a-80b9150a57ae",
            expect.any(Object), // "e07c2f1d-5f5a-488a-a505-34f7b9f55105",
            expect.any(Object), // "f1470597-1a3c-4a76-8546-2c29591a6846",
          ],
